...
jpeg(file = "Fig0_example.jpg",width =1600,height = 1600,units = "px",res =300)
fig0
dev.off()
fig0
```
...
```
```{r}
Results1=plot_grid(fig1, NULL,fig0, nrow = 1, rel_widths = c(1, 0.2, 1))
jpeg(file = "Results1.jpg",width =3200,height = 1600,units = "px",res =300)
Results1
dev.off()
Results1
```
...
```{r}
pointdata=df
fig7=ggplot(pointdata, aes(x=distance, y=contagion, color=Risk)) + 
...
```
```{r}
Results3=plot_grid(fig6, NULL,fig7, nrow = 1, rel_widths = c(1, 0.2, 1))

jpeg(file = "Results3.jpg",width =3200,height = 1600,units = "px",res =300) #结果保存
Results3
dev.off()
Results3
```
...
fig8a=ggplot(df, aes(x=distance, y=contagion,shape=Domain,color=Risk)) + 
  geom_point(size=5,alpha=0.5)+
  scale_color_manual(values=c("#22DFA9","#DF22A9"))+
  geom_smooth(method=lm,se=F,size=1.3,alpha=1)+
  labs(y="Contagion Effect", x="Risk-preference Distance", color="Observee's 
Risk-preference",shape="Decision Frame")+
  theme_bw()+
  theme 
jpeg(file = "Fig8_Dis_con_all.jpg",width =3200,height = 1600,units = "px",res =300) #结果保存
fig8a
dev.off()
fig8a
...
fig8b=ggplot(df, aes(x=distance, y=contagion)) + 
  geom_point(size=5,alpha=0.5)+
  geom_smooth(method=lm,se=F,size=1.3,alpha=1)+
  labs(y="Contagion Effect", x="Risk-preference Distance", color="Observee's 
Risk-preference",shape="Decision Frame")+
...
fig8c=ggplot(df, aes(x=distance, y=contagion,shape=Domain)) + 
  geom_point(size=5,alpha=0.5)+
  geom_smooth(method=lm,se=F,size=1.3,alpha=1)+
  labs(y="Contagion Effect", x="Risk-preference Distance", color="Observee's 
Risk-preference",shape="Decision Frame")+
  ...
  theme 
jpeg(file = "Fig8_Dis_con_Domain.jpg",width =1500,height = 1400,units = "px",res =300) #结果保存
fig8c
dev.off()
fig8c
...
```{r}
Results_sup3=plot_grid(fig8b, NULL,fig8c, nrow = 1, rel_widths = c(1, 0.2, 1))

jpeg(file = "Res_sup3.jpg",width =3200,height = 1600,units = "px",res =300) #结果保存
Results_sup3
dev.off()
Results_sup3
```
...
```
```{r}
Sup4=plot_grid(fig101, NULL,fig102, nrow = 1, rel_widths = c(1, 0.2, 1))

jpeg(file = "Res_sup4_RegressTo.jpg",width =3200,height = 1600,units = "px",res =300) #结果保存
Sup4
dev.off()
Sup4
```
...
```
```{r}
Sup5=plot_grid(fig103a, NULL,fig103b, nrow = 1, rel_widths = c(1, 0.2, 1))

jpeg(file = "Res_sup5_Baseline.jpg",width =3200,height = 1600,units = "px",res =300) #结果保存
Sup5
dev.off()
Sup5
```
