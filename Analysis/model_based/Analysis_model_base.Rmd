...
Data_free=read.csv("F:/Lusha Lab/writing up/All_Data_model_free.csv")
Data=read.csv("F:/Lusha Lab/writing up/All_Data_model_base.csv")
Data_model=Data
...
fig1=ggplot(D, aes(x= Domain,y=Session_1,fill=Domain)) + 
  ...
  geom_signif(y_position=c(0.028), xmin=c(1), xmax=c(2), annotation=c("*"), tip_length=0, size=0.4, textsize = 7,vjust = 0)+
  theme_bw()+ 
  guides(fill=F)+
  theme+ 
  ylab("Risk Preference")+xlab("Decision Frame")+ylim(c(-0.04,0.03))
jpeg(file = "aFig1_start.jpg",width =1600,height = 1600,units = "px",res =300)
fig1
dev.off()
fig1
...
jpeg(file = "aFig0_free_vs_base.jpg",width =1600,height = 1600,units = "px",res =300)
fig0
dev.off()
fig0
```
...
fig2a=ggplot(data0, aes(x=Domain,y=Contagion,fill=Domain))+
  ...
  geom_signif(y_position=c(0.012),xmin=c(1),xmax=c(1),annotation=c("***"),tip_length=0,size=0,textsize=7,vjust=0.5)+
  geom_signif(y_position=c(0.012),xmin=c(2),xmax=c(2),annotation=c("***"),tip_length=0,size=0,textsize=7,vjust=0.5)+
  geom_signif(y_position=c(0.015),xmin=c(1),xmax=c(2),annotation=c("n.s."),tip_length=0,size=0,textsize=5,vjust=0)+
...
fig2b=ggplot(data0, aes(x=factor(Risk),y=Contagion,fill=factor(Risk)))+
  ...
  geom_signif(y_position=c(0.012),xmin=c(1),xmax=c(1),annotation=c("***"),tip_length=0,size=0,textsize=7,vjust=0.5)+
  geom_signif(y_position=c(0.012),xmin=c(2),xmax=c(2),annotation=c("***"),tip_length=0,size=0,textsize=7,vjust=0.5)+
  geom_signif(y_position=c(0.015),xmin=c(1),xmax=c(2),annotation=c("***"),tip_length=0,size=0,textsize=7,vjust=0.5)+
...
jpeg(file = "aFig2_Allcontagion.jpg",width =2400,height = 1400,units = "px",res =300) 
fig2
dev.off()
fig2
...
fig3=ggplot(data2, aes(x=Domain,y=contagion,fill=Risk))+
  ...
  scale_fill_manual(values=c("#22DFA9", "#DF22A9"))+
  geom_signif(y_position=c(0.016),xmin=c(1.775),xmax=c(2.225),annotation=c("***"),tip_length=0.05, size=0.4, textsize=7,vjust=0.5)+
  geom_signif(y_position=c(0.016),xmin=c(0.775),xmax=c(1.225),annotation=c("n.s."),tip_length=0.05, size=0.4, textsize=5,vjust=0)+
...
jpeg(file = "aFig3_InterContagion.jpg",width =2200,height = 1400,units = "px",res =300) 
fig3
dev.off()
fig3
```
...
jpeg(file = "aSup3_IndividualContagion.jpg",width =1600,height = 1400,units = "px",res =300) 
sup3
dev.off()
sup3
...
fig4=ggplot(data2, aes(x=Domain,y=distance,fill=Risk))+
  ...
  scale_fill_manual(values=c("#22DFA9", "#DF22A9"))+
  geom_signif(y_position=c(0.02), xmin=c(1.775), xmax=c(2.225), annotation=c("n.s."), tip_length=0.05, size=0.4, textsize = 5,vjust = 0)+
  geom_signif(y_position=c(0.02), xmin=c(0.775), xmax=c(1.225),annotation=c("**"), tip_length=0.05, size=0.4, textsize = 7,vjust = 0.5)+
...
jpeg(file = "aFig4_InterDistance.jpg",width =2200,height = 1400,units = "px",res =300) 
fig4
dev.off()
fig4
```
...
fig5=ggplot(data2, aes(x=Domain,y=contagion_ratio,fill=Risk))+
  ...
  scale_fill_manual(values=c("#22DFA9", "#DF22A9"))+
  geom_signif(y_position=c(0.88), xmin=c(1.775), xmax=c(2.225), annotation=c("**"), tip_length=0.05, size=0.4, textsize = 7,vjust = 0.5)+
  geom_signif(y_position=c(0.88), xmin=c(0.775), xmax=c(1.225),annotation=c("*"), tip_length=0.05, size=0.4, textsize = 7,vjust = 0.5)+
  labs(x="Decision Frame", y="Contagion Ratio", fill="Observee's risk
 preference")+
  theme_bw()+
  theme

jpeg(file = "aFig5_InterContagion_ratio.jpg",width =2200,height = 1400,units = "px",res =300) 
fig5
dev.off()
fig5
```
...
fig6=ggplot(data3, aes(x=Risk,y=contagion_ratio,fill=Risk))+
  ...
  geom_signif(y_position=c(0.72), xmin=c(1), xmax=c(2),annotation=c("***"), tip_length=0.05, size=0.4, textsize = 7,vjust = 0.5)+
  theme_bw()+
  guides(fill=F)+
  theme

  
jpeg(file = "aFig6_contagion_ratio_risk.jpg",width =1100,height = 1400,units = "px",res =300) 
fig6
dev.off()
fig6
```
...
risk preference",color="Decision Frame")+
  theme_bw()+
  theme 
jpeg(file = "aFig7_riskDis_con.jpg",width =1800,height = 1400,units = "px",res =300) #结果保存
fig7
dev.off()
fig7
...
risk preference",color="Decision Frame")+
  theme_bw()+
  theme 
jpeg(file = "aFig8_Dis_con.jpg",width =1500,height = 1400,units = "px",res =300) #结果保存
fig8
dev.off()
fig8
...
fig101<-ggplot(D, aes(x= ses,y=M,fill=factor(domain),color=domain)) + 
  ...
  geom_signif(y_position=c(0.01), xmin=c(2), xmax=c(4),annotation=c("n.s."), tip_length=0, size=0.5, textsize = 7,vjust = 0,color="black")+
  theme_bw()+ 
  guides(fill=F)+
...
jpeg(file = "aFig101_RegressToMean.jpg",width =1800,height = 1400,units = "px",res =300) #结果保存
fig101
dev.off()
fig101
...
fig102<-ggplot(D, aes(x= ses,y=M,fill=factor(domain),color=domain)) + 
  ...
  scale_color_manual(values=c("red","blue"))+
  scale_fill_manual(values=c("#FF77CC", "#77CCFF"))+
  geom_signif(y_position=c(0.013), xmin=c(1), xmax=c(4),annotation=c("n.s."), tip_length=0, size=0.5, textsize = 7,vjust = 0,color="black")+
  theme_bw()+ 
  guides(fill=F)+
  labs(x="Session", y="Risk Preference",fill="Observee's risk")+
  theme+ 
...
jpeg(file = "aFig102_RegressToNeutral.jpg",width =1800,height = 1400,units = "px",res =300) #结果保存
fig102
dev.off()
fig102
```
...
jpeg(file = "aFig103a_regressToBaseline.jpg",width =1800,height = 1400,units = "px",res =300) #结果保存
fig103a
dev.off()
fig103a
```
...
fig103b<-ggplot(D, aes(x= ses,y=M,fill=factor(domain),color=domain)) + 
  ...
  scale_color_manual(values=c("red","blue"))+
  scale_fill_manual(values=c("#FF77CC", "#77CCFF"))+
  geom_signif(y_position=c(0.017), xmin=c(2), xmax=c(4),annotation=c("n.s."), tip_length=0, size=0.5, textsize = 7,vjust = 0,color="black")+
  theme_bw()+ 
  guides(fill=F)+
  labs(x="Session", y="Risk Preference",fill="Observee's risk")+
  theme+ 
...
jpeg(file = "aFig103b_regressToBaseline.jpg",width =1800,height = 1400,units = "px",res =300) #结果保存
fig103b
dev.off()
fig103b
```
...
fig202=ggplot(data1, aes(x=Risk,y=Similar,fill=Risk))+
  ...
  scale_fill_manual(values=c("#22DFA9", "#DF22A9"))+
  geom_signif(y_position=c(5), xmin=c(1), xmax=c(2),annotation=c("**"), tip_length=0.05, size=0.4, textsize = 7,vjust = 0.5)+
...
jpeg(file = "aFig205_similar_cor.jpg",width =1400,height = 1400,units = "px",res =300) 
...
jpeg(file = "aFig203_similar_con.jpg",width =1800,height = 1400,units = "px",res =300) #结果保存
fig203
dev.off()
fig203
```
...
jpeg(file = "aFig204_similar_dis.jpg",width =1800,height = 1400,units = "px",res =300) 
fig204
dev.off()
fig204
...
jpeg(file = "aFig301_correlationPre_CO.jpg",width =1600,height = 1600,units = "px",res =300) #结果保存
corrplot(b,method="color",type="upper",addCoef.col="gray")
dev.off()
corrplot(b,method="color",type="upper",addCoef.col="gray")
